...
export default function AboutUsBody() {
  return (
    <section className='aboutUs-body'>
      ...
      <p>
        Si contas con tu propio negocio o queres empezar tu emprendimiento nosotros te ayudamos. Contactanos al WhatsApp: 11 5046-0184 para poder asesorate y enviarte nuestro catalogo mayorista, con
        listado de precios y fotos de todos nuestros calzados.
      </p>
      <br />
      <div>
      ...
      <p>
        Como nuestro principal objetivo es que estés satisfecho con tu compra, te ofrecemos 10 días para poder realizar el cambio de tus productos en forma gratuita, ante las siguientes situaciones:
      </p>
      <ul>
